...
% --- Footer --- %
\footer{References and Capstone documentation available at  https://github.com/pobega/college}
...
\begin{main}
  \section{Work Experience}
    \experience{Neverware}{New York, NY}{Software Developer}{September 2016 - Present}
      ...
      \point {Debugs and resolves hardware compatibility issues in CloudReady}
        \subpoint {Works closely with Product and Sales to resolve customer issues}
        \subpoint {Manages driver compatibility and patches hardware quirks in Linux kernel}
      \point {Merges upstream code back into Neverware's forks \& handles merge conflicts and build issues}
    ...
    \experience{SUNYIT ITS Department}{Utica, NY}{Linux System Administrator}{September 2013 - May 2014}
      ...
      \point {Reimplemented legacy mailing list software in Perl \& integrate with existing LDAP}
  ...
  \section{Personal Projects}
    ...
    \experience{com.fightcade.Fightcade}{2020}{Fightcade application Flatpak}{YAML/Shell}
      ...
      \point {Bundles custom 32-bit Wine build for running emulators}
\end{main}
\end{document}